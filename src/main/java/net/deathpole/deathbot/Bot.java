...
public class Bot extends ListenerAdapter {
    ...
    private static GlobalDao globalDao = new GlobalDao();
    ...
    public static void main(String[] args) {
        try {
            ...
            for (Guild guild : jda.getGuilds()) {
                HashMap<String, ReminderDTO> remindersForGuild = globalDao.getRemindersForGuild(guild);

                ReminderThread reminderThread = new ReminderThread(guild);
                reminderThread.setReminders(remindersForGuild);

                reminderThread.start();
                reminderThreadsByGuild.put(guild.getName(), reminderThread);
            }
