...
/**
 * Created by nicolas on 23/10/17.
 */
 ...
 */
class NaturalSortComparator<T> implements  Comparator<T> {

    public static final Comparator<String> NUMERICAL_ORDER = new NaturalSortComparator<String>(false);
    public static final Comparator<String> CASEINSENSITIVE_NUMERICAL_ORDER = new NaturalSortComparator<String>(true);

    private final boolean caseInsensitive;

    NaturalSortComparator(boolean caseInsensitive) {
